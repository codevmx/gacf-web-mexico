...
<head>
    <meta charset="utf-8" />
    <title>Portal GACF | Actualizar Contraseña</title>
    ...
    <!-- JS app -->
    <script src="/gacf-web-mexico/login/js/actualizar-pwd.js"></script>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                ...
                                <h4 class="text-dark-50 text-center pb-0">Actualizar Contraseña</h4>
                            </div>
