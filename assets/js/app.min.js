...
!(function (o) {
  function e() {
    ...
    _toConsumableArray(
      ...
      _toConsumableArray(document.querySelectorAll(".offcanvas")).map(function (
        e
      ) {
  ...
  e(),
    ...
    o(document).on("click", function (e) {
      return (
        "top-search" == e.target.id || e.target.closest("#search-dropdown")
          ? o("#search-dropdown").addClass("show")
          : o("#search-dropdown").removeClass("show"),
        !0
      );
    }),
    ...
    (r = document.querySelector('[data-toggle="fullscreen"]')) &&
    ...
    jQuery().mask &&
      o('[data-toggle="input-mask"]').each(function (e, t) {
        var n = o(t).data("maskFormat"),
          a = o(t).data("reverse");
        null != a ? o(t).mask(n, { reverse: a }) : o(t).mask(n);
      }),
    jQuery().TouchSpin &&
      ((i = {}),
    ...
    _createClass(e, [
              ...
              (e &&
                e.addEventListener("click", function (e) {
                  "light" === n.config.theme
                    ? n.changeLayoutColor("dark")
                    : n.changeLayoutColor("light");
                }),
          ...
          e &&
            ...
            document.querySelectorAll(".button-sm-hover").forEach(function (e) {
              e.addEventListener("click", function () {
                var e = n.config.sidenav.size;
                "sm-hover-active" ===
                n.html.getAttribute("data-sidenav-size", e)
                  ? n.changeLeftbarSize("sm-hover", !1)
                  : n.changeLeftbarSize("sm-hover-active", !1);
              });
            });
        },
      },
        ...
        value: function () {
          ...
          window.innerWidth <= 767.98
            ...
            ? "full" !== e.config.sidenav.size &&
              ...
              ("sm-hover" === e.config.sidenav.size
                ? e.changeLeftbarSize("condensed")
                : e.changeLeftbarSize("condensed", !1))
      ...
      },
      {
        ...
        value: function () {
          ...
          s &&
            ((e = document.querySelector(
              "input[type=checkbox][name=data-layout][value=" + s.nav + "]"
            )),
            (t = document.querySelector(
              "input[type=checkbox][name=data-bs-theme][value=" + s.theme + "]"
            )),
